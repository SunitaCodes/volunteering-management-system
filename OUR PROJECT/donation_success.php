...
function render_page($ok, $title, $subtitle, $details = []) {
    ...
    include('header.php'); // top nav/menu like my_signups
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
// update donations
$stmt = $link->prepare(
    "UPDATE donations SET Status='success', TransactionCode=?, UpdatedDate=NOW() WHERE TransactionUniqueId=?"
);
...
render_page(true, "Thank You for Your Donation!", "Your generosity is making an impact.", [
